...
md5_server=$(curl https://raw.githubusercontent.com/prtha112/pgscan/master/pgscan | md5sum | awk '{print $1}' | tail -1)
...
wget -P /usr/local/bin/ https://raw.githubusercontent.com/prtha112/pgscan/master/pgscan
